package com.example.gd11_c_0762
...
import com.example.gd11_c_0762.adapters.MahasiswaAdapter
import com.example.gd11_c_0762.api.MahasiswaApi
import com.example.gd11_c_0762.models.Mahasiswa
...
class MainActivity : AppCompatActivity() {
    private var srMahasiwa: SwipeRefreshLayout? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        srMahasiwa = findViewById(R.id.sr_mahasiswa)
        svMahasiswa = findViewById(R.id.sv_mahasiswa)

        srMahasiwa?.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener{ allMahasiswa() })
