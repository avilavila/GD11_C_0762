...
import com.example.gd11_c_0762.AddEditActivity
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Budi Budiman"), closeSoftKeyboard())
...
//        pressBack()
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200712345"), closeSoftKeyboard())
